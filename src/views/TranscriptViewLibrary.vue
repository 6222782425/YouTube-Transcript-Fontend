...
export default {
  ...
  created() {
    const video = this.$route.query.data;
    this.fullTranscript = video.fullTranscript;
    this.summarizeTranscript = video.summarizeTranscript;
  ...
  methods: {
    ...
    //     thubnall: `https://img.youtube.com/${this.youtubeURLId}/default.jpg`,
    //     url: this.youtubeURL,
    //   };
